...
When you turn on the application, the cities you have added will be shown (if any),if not, click on the + in the upper left corner and add your city, after which you will be returned to the first screen.
If you want to delete city, click on the city and choose delete
